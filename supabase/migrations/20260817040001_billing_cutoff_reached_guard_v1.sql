-- FlowLedger Backend v1 — Billing cutoff must be reached before period finalization
-- Immutable allocation snapshot cannot be created before the deterministic bill_date 12:00 Europe/Istanbul cutoff.
